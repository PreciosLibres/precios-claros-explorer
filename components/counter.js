    ...
    <article className="pa3 pa5-ns" data-name="slab-stat-large">
      ...
      <div className="cf mt5">
        ...
        <dl className="db dib-l w-auto-l lh-title mr6-l">
          ...
          <dd className="f-subheadline-l fw5 ml0">Día</dd>
        </dl>
        <dl className="db dib-l w-auto-l lh-title">
          <dd className="f6 fw4 ml0">Promedio de costo de la canasta familiar hoy</dd>
          <dd className="f-subheadline-l fw5 ml0">$1,200</dd>
        </dl>
      </div>
    </article>
  </div>
